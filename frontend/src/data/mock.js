// Mock data for IIT Jammu academic catalog
// Source: public information about IIT Jammu (an Institute of National Importance, founded 2016, Jagti, Nagrota, J&K)
...
export const DEPARTMENTS = {
  'cse-computer-science-engineering': {
    ...
    description:
      'The Department of Computer Science and Engineering at IIT Jammu offers a comprehensive curriculum spanning algorithms, systems, AI/ML, and emerging areas such as quantum computing and cyber-physical systems, with a strong emphasis on research and innovation.',
    courses: [
  ...
  'ece-electronics-communication': {
    ...
    description:
      'ECE at IIT Jammu emphasizes design of analog and digital systems, signal and image processing, VLSI, embedded systems, and modern wireless communication networks.',
    courses: [
  ...
  'ee-electrical-engineering': {
    ...
    description:
      'Electrical Engineering at IIT Jammu addresses power systems, control, electric drives, renewable energy, and smart grids — with strong industry and research linkages.',
    courses: [
  ...
  'me-mechanical-engineering': {
    ...
    description:
      'Mechanical Engineering at IIT Jammu covers solid and fluid mechanics, thermodynamics, manufacturing, robotics, and computational design.',
    courses: [
  ...
  'ce-civil-engineering': {
    ...
    description:
      'Civil Engineering at IIT Jammu prepares students for the design and construction of resilient infrastructure, sustainable buildings, transportation, and water resources.',
    courses: [
  ...
  'che-chemical-engineering': {
    ...
    description:
      'Chemical Engineering at IIT Jammu integrates process design, transport phenomena, reaction engineering, and sustainable process technology.',
    courses: [
  ...
  'mse-materials-engineering': {
    ...
    description:
      'Materials Science & Engineering covers structure-property relationships in metals, ceramics, polymers, and composites, with a focus on nano-materials and energy materials.',
    courses: [
  ...
  'mth-mathematics': {
    ...
    name: 'Mathematics',
    description:
      'Mathematics courses build rigorous foundations in analysis, algebra, probability, and computation that support all engineering and science programs at IIT Jammu.',
    courses: [
  ...
  'phy-physics': {
    ...
    name: 'Physics',
    description:
      'Physics at IIT Jammu provides core foundations in mechanics, electromagnetism, quantum mechanics, and modern applied physics including photonics and condensed matter.',
    courses: [
  ...
  'chm-chemistry': {
    ...
    name: 'Chemistry',
    description:
      'Chemistry at IIT Jammu equips students with foundations in physical, organic, inorganic, and analytical chemistry relevant to engineering and applied science.',
    courses: [
  ...
  'hss-humanities-social-sciences': {
    ...
    description:
      'HSS courses develop communication, ethical reasoning, economics, and history \u2014 producing well-rounded engineers and scientists.',
    courses: [
...
// Faculty data per group
export const FACULTY_GROUPS = {
  leadership: {
    title: 'Institute Leadership',
    intro:
      'IIT Jammu is led by a Director and supported by Deans across academics, research, faculty affairs, infrastructure, and student welfare.',
    members: [
  ...
  'cse-faculty': {
    title: 'CSE Faculty',
    intro:
      'The Computer Science & Engineering department has faculty spanning theory, systems, machine learning, security, and human-computer interaction.',
    members: [
  ...
  'ece-faculty': {
    title: 'ECE Faculty',
    intro:
      'ECE faculty work on VLSI, communications, signal processing, RF and microwave systems, and embedded electronics.',
    members: [
  ...
  'me-faculty': {
    title: 'ME Faculty',
    intro:
      'Mechanical Engineering faculty research thermofluids, manufacturing, robotics, energy systems, and computational mechanics.',
    members: [
  ...
  'sciences-faculty': {
    ...
    intro:
      'Faculty across Mathematics, Physics, Chemistry, and Humanities & Social Sciences support the foundational and contextual education of every IIT Jammu student.',
    members: [
...
export const FEES_DATA = {
  'tuition-fees': {
    title: 'Tuition & Fees',
    intro:
      'IIT Jammu fees are set in accordance with the Ministry of Education, Government of India guidelines. The figures below are indicative and may be revised. Please consult the Academic Section for current rates.',
    tables: [
      {
  ...
  'hostel-mess': {
    ...
    intro:
      'Most undergraduate and graduate students reside on campus. Hostel and mess charges are payable per semester.',
    tables: [
      {
  ...
  scholarships: {
    ...
    intro:
      'IIT Jammu offers merit-cum-means scholarships, MCM tuition waivers, institute free studentships, and ST/SC fellowships, alongside several externally sponsored awards.',
    tables: [
      {
...
export const INFO_PAGES = {
  ...
  history: {
    ...
    body: [
      ...
      'Initial academic operations began at a temporary campus while the permanent campus was constructed at Jagti, Nagrota, in the union territory of Jammu and Kashmir. The institute relocated to its permanent campus in 2019, where modern teaching, residential, and research facilities have since expanded.',
